...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
   ...
   <c style="font-family: 'Germania One', cursive;"><b><?=$row['price']."&nbsp"."Rupees";?></b></c><br><br>
	<!-- <input type="submit" name="submit" value="Buy Now">&nbsp&nbsp&nbsp&nbsp -->
	<button type="submit" name="cart" onclick="funb()">Add to Cart</button>
	&nbsp&nbsp&nbsp&nbsp&nbsp
	Quantity:<input type="number" name="alfahm" min="0" max="5" size="2" value="0">
</div>
</form>
