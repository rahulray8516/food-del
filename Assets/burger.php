...
$query = mysql_query("SELECT * from ownerdata where itemname = 'burger'");
...
<div id="top">
	<ul>
		...
		<li><a href="">Help</li></a>
		<li><a href="mallu.php">Mallu Dhaba</li></a>
...
<br>
	...
	Quantity:<input type="number" name="quantity" min="0" max="5" size="2" value="0">
</div>
</form>
